...
- **Installer script**: `docs/install.sh` is the canonical installer, served by GitHub Pages at `get.nrcc.dev/install.sh`. Edit that file directly; the URL is the contract.
