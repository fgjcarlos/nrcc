    ...
    <>
      <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6 mb-8">
        <div>
          ...
          <h2 className="text-3xl font-bold tracking-tight text-base-content mt-1">Backups</h2>
      ...
      <article className="surface-card border border-base-300/60 p-6 md:p-7">
        <div className="mb-5">
          <h3 className="text-xl font-semibold text-base-content">Backup history</h3>
