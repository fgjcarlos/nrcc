...
// OpenForDownload and Download are implemented in backup_linux.go
// (//go:build linux) — they call openNoFollow, which uses
// syscall.O_NOFOLLOW + syscall.Fstat + syscall.Stat_t.
